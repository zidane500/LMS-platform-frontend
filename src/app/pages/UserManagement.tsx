...
import { getAllUsers, adminUpdateUser, adminDeleteUser } from '../services/userService';
...
export const UserManagement: React.FC = () => {
  ...
  const handleUpdateUser = async () => {
    ...
    try {
      const updated = await adminUpdateUser(editingUser.id, {
        ...
        role:   editingUser.role === 'learner' ? 'apprenant' : editingUser.role === 'instructor' ? 'formateur' : 'admin',
      });
  ...
  const roleBadgeClass = (role: string) =>
    ...
    role === 'instructor' ? 'bg-indigo-100 text-indigo-700' : 'bg-purple-100 text-purple-700';

  const roleLabel = (role: string) =>
    role === 'admin' ? 'Admin' : role === 'instructor' ? 'Formateur' : 'Apprenant';
      ...
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
              <Users className="w-8 h-8 text-blue-600" /> Gestion des utilisateurs
            </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <Input value={searchQuery} onChange={e => setSearchQuery(e.target.value)} placeholder="Rechercher par nom ou email..." className="pl-10" />
          </div>
        ...
        {loading ? (
          ...
          <Card><CardContent className="text-center py-12 text-gray-500">Aucun utilisateur trouvé</CardContent></Card>
        ) : (
                    ...
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-3 shrink-0">
                        ...
                        {user.id !== currentUser.id && (
                          <Button variant="destructive" size="sm" onClick={() => setUserToDelete(user)} className="gap-1">
        ...
        <DialogContent>
          ...
          {editingUser && (
            <div className="space-y-4 py-2">
              ...
              <div className="space-y-1">
                <Label>Rôle</Label>
                <Select value={editingUser.role} onValueChange={v => setEditingUser({ ...editingUser, role: v as any })}>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <strong>{userToDelete?.firstName} {userToDelete?.lastName}</strong> ? Cette action est irréversible.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
